...
- (NSURL *)applyPublicKeyURL{
    return [NSURL URLWithString: [NSString stringWithFormat: @"http://%@:8080/safencrypt/apply-public-key?type=1" , HOST_IP]];
}
...
- (NSURL *)signUpClientURL{
    return [NSURL URLWithString: [NSString stringWithFormat: @"http://%@:8080/safencrypt/sign-up-client" , HOST_IP]];
}
...
- (NSArray<NSString *> *)encryptDomainList{
    return @[[NSString stringWithFormat: @"%@:8080" , HOST_IP]];
}
