...
var safencrypt_config = {
    // 申请公钥的URL
    apply_public_key_url: "http://10.32.159.160:12024/safencrypt/apply-public-key",
    // 注册客户端的URL
    sign_up_client_url: "http://10.32.159.160:12024/safencrypt/sign-up-client",
    // 基于客户端的请求地址数组
    base_on_client_urls: [
        'http://10.32.159.160:9090/alpha/scheduled/jobs',
        'http://10.32.159.160:9090/alpha/test/jobs'
    ],
    // 不加密的请求地址数组
    non_encrypt_urls: ['http://localhost:8080/non-encrypt-msg'],
    // 是否开启调试
